    ...
    <transition name="dropdown">
      <nav
        ...
        <div
          ...
          <h1 class="text-light-primary dark:text-dark-primary">Contact </h1>
          <section class="flex flex-col w-48 h-48 border-2 border-sky-blue rounded-md p-5 gap-y-1">
            <header class="flex items-center justify-center w-full h-full bg-sky-blue">
              <p class="text-white text-xs">Back-end developer</p>
            </header>
          </section>
        ...
        <div
          ...
          <h1 class="text-light-primary dark:text-dark-primary">Desktop</h1>
          <section class="flex flex-col w-48 h-48 border-2 border-sky-blue rounded-md p-5 gap-y-1">
        ...
        <div
          ...
          <h1 class="text-light-primary dark:text-dark-primary">Mobile</h1>
          <section class="flex flex-col w-48 h-48 border-2 border-sky-blue rounded-md p-5 gap-y-1">
            <header class="h-4 w-full bg-sky-blue"></header>
