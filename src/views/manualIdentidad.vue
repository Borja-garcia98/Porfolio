  ...
  <figure class="md:flex rounded-xl p-8 md:p-0 sub">
    ...
    <div class="pt-6 md:p-8 text-left md:text-left space-y-4">
      <div class="font-medium">
        <a class="text-sky-blue sub " download="Descarga mi Manual de Identidad" href="/Manual.pdf">Descargar Manual de identidad</a>
      </div>
      ...
      <div class="">
        ...
        <video-embed title="videoManual" class="video" src="https://youtu.be/Yd_c3mIK1WA"> </video-embed>
      </div>
    </div>
  </figure>
</template>
